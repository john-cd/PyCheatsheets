...
class Bunch(object):
    ...
    # Status: tested
    # History: added __repr__ June 29, 2014.
    ...
    def __repr__(self):
        ...
        # note: you can modify representation with repr.aRepr./someattribute/
        # as needed
    ...
    def partialcopy(self, *attributenames):
        ...
        """
        d = {k: v for k, v in list(self.__dict__.items()) if k in attributenames}
        return Bunch(**d)
    ...
    def asOrderedDict(self, *attributenames):
        ...
        """
        ol = [(k, v) for k, v in list(self.__dict__.items()) if k in attributenames]
    ...
    def getnames(self):
        ...
        )  # or: vars(self).keys() or inspect.getmembers(self)
...
def _example_Bunch():
    ...
    bb = Bunch(**{chr(90 + i % (123 - 90)) + str(i): i for i in range(1000)})
